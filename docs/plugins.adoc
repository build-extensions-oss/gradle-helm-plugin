...
All plugins IDs are prefixed the namespace `io.github.build-extensions-oss`.
...
----
plugins {
    id 'io.github.build-extensions-oss.helm-commands' version '{project-version}'
}
----
...
----
plugins {
    id 'io.github.build-extensions-oss.helm' version '{project-version}'
}
----
...
----
plugins {
    id 'io.github.build-extensions-oss.helm-publish' version '{project-version}'
}
----
...
----
plugins {
    id 'io.github.build-extensions-oss.helm-releases' version '{project-version}'
}
----
